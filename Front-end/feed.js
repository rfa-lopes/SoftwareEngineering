        ...
        success: function(response) {
            if(response) {
                ...
                for(var k=0; k<response.length;k++){
                    m+='<div class="col-lg-4"><div class="product__discount__item"><div id="'+response[k].id+'" class="product__discount__item__pic set-bg" data-setbg="data:image/png;base64,'+response[k].image+'"><ul class="product__item__pic__hover"><li><a href="#sharestorymodal" data-toggle="modal" onclick="save('+response[k].id+')"><i class="fa fa-retweet"></i></a></li><li><a href="#postModal" data-toggle="modal"><i class="fa fa-envelope"></i></a></li></ul></div><div class="product__discount__item__text"><h5><a>'+ username +'</a></h5></div></div></div>';
                }
        ...
        success: function(response) {
            if(response) {
                ...
                for(var i=0; i<response.length;i++){
                    ...
                    n += '<div class="col-lg-4 col-md-6 col-sm-6"><div class="product__item"><div id="'+response[i].id+'" class="product__item__pic set-bg" data-setbg="data:image/jpeg;base64,' + response[i].image + '" data-desc="'+response[i].description+'" data-img="'+response[i].image+'"><ul class="product__item__pic__hover"><li><a href="#postModal" data-toggle="modal" onclick="save('+response[i].id+')"><i class="fa fa-heart"></i></a></li><li><a href="#postModal" data-toggle="modal" onclick="save('+response[i].id+')"><i class="fa fa-comment"></i></a></li><li><a href="#sharepostmodal" data-toggle="modal" onclick="save('+response[i].id+')"><i class="fa fa-retweet"></i></a></li><li><a href="#"><i class="fa fa-plus"></i></a></li></ul></div><div class="product__item__text"><h6><a href="#">' + response[i].description + '</a></h6><h5>' + username + '</h5></div></div></div>';
                     
                }
                document.getElementById("postsdiv").innerHTML += n;
                for(var j=0; j<response.length;j++){
                    document.getElementById(response[j].id).style.backgroundImage= "url('data:image/jpeg;base64,"+ response[j].image+ "')";
                }
            }
            else {
                alert("No response");
