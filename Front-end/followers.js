    ...
    $.ajax({
        ...
        success: function(response) {
            if(response) {
                ...
                var n = '<div class="row"><h2>'+response.username+'</h2><button class="btn follow-btn" id="follow_btn_prof" data-toggle="modal" data-target="#followmodal" onclick="save('+id+')"> Follow </button></div>';
